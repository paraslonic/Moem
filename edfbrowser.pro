...
HEADERS += paraslonic/report_dialog.h
HEADERS += paraslonic/qcustomplot.h


SOURCES += paraslonic/report_dialog.cpp
SOURCES += paraslonic/clever_scoring.cpp
SOURCES += paraslonic/qcustomplot.cpp
SOURCES += main.cpp
