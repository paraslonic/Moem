...
#define MAXPREDEFINEDMONTAGES 8
...
enum TStage
{
	s_NA = -1, s_Wake = 0, s_SW = 1, s_REM = 2, s_WakeQuest, s_SWQuest, s_REMQuest 
};



 const char* const sw_string = "SW";
 const char* const rem_string = "REM";
 const char* const wake_string = "Wake";
 const char* const na_string = "na";
 const char* const pw_string = "pw";
 const int IMOTIONSIGNALTASK = 101;
 const int IOUTLIERSIGNALTASK = 102;
