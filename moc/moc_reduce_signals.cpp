...
**
** Created: Mon 23. Feb 20:39:00 2015
...
static const char qt_meta_stringdata_UI_ReduceSignalsWindow[] = {
    ...
    "Deselect_all_signals()\0spinBox1changed(int)\0"
    "spinBox2changed(int)\0radioButton1Toggled(bool)\0"
...
void UI_ReduceSignalsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->spinBox1changed((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 5: _t->spinBox2changed((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->radioButton1Toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 7: _t->radioButton2Toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
